...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private Store getShop(Cursor cursor) {
		...
		Log.d("Alain", "getShop nb  " + cursor.getCount());
		return shop;
	}
	...
	public Cursor getShops() {
		...
		Log.d("Alain", "getShops nb  " + cursor.getCount());
		return cursor;
	}
	...
	public Cursor getProducts(int shopId) {
		...
		Cursor cursor = db.rawQuery(sql, null);
		cursor.moveToFirst();
		Log.d("Alain", "getProducts nb " + cursor.getCount());
		return cursor;
	}
	public Product getProduct(Cursor cursor) {
		...
		Log.d("Alain", "getProduct nb " + cursor.getCount());
		return product;
	}
