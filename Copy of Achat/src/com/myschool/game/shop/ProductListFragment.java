...
/*		setListAdapter(new ArrayAdapter<DummyContent.DummyItem>(getActivity(),
	...
	public void display(Bundle bundle) {
		...
		mCursor = mDatabaseHelper.getProducts(mBundle.getInt("shop_id"));

		SimpleCursorAdapter adapter = new SimpleCursorAdapter(getActivity(),
				android.R.layout.simple_list_item_activated_1, mCursor,
				new String[] { DatabaseHelper.KEY_PRODUCT_NAME },
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		Product product = mDatabaseHelper.getProduct(mCursor);
		mCallbacks.onItemSelected(product.getId());
